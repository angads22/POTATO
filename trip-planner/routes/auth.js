...
router.post("/register", async (req, res) => {
  ...
  // invite check. Everyone after needs the invite code.
  const isFirstUser = db.userCount() === 0;
  if (!isFirstUser && inviteCode !== config.INVITE_CODE) {
...
// Tells the registration screen whether this is the first-run admin setup.
